...
describe('login slice', () => {
    ...
    it('should handle setLoginField', () => {
        let newState = loginReducer(initialState, setLoginField({ key: 'phoneNumber', value: '1234567890' }));
        newState = loginReducer(newState, setLoginField({ key: 'password', value: 'Test@1234' }));
    ...
    it('should handle setLoginSuccess', () => {
        const newState = loginReducer(initialState, setLoginSuccess({accessToken:'accesToken1',refreshToken:'refreshToken1'}));
