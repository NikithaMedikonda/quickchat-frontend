...
describe('Registration Screen', () => {
  ...
  it('submits form and resets fields', () => {
    const { getByPlaceholderText,getByText, queryByDisplayValue } = render(<Registration />);
    ...
    fireEvent.changeText(getByPlaceholderText('Email (Optional)'), 'testuser@gmail.com');
